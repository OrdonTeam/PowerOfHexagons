...
public class ScoreCalculator {
	...
	private void updateMaxValue() {
		SharedPreferences preferences = main
	...
	private void showCongrats(int maxLocalValue) {
		...
		case 2048:
			Toast.makeText(
					main,
					"New achivement: " + maxLocalValue
							+ "\nYou can try harder.", Toast.LENGTH_LONG)
					.show();
			break;
		case 4096:
			Toast.makeText(
					main,
					"New achivement: " + maxLocalValue
							+ "\n4096 is not that big", Toast.LENGTH_LONG)
					.show();
			break;
		case 8192:
			Toast.makeText(
		...
		case 16384:
			Toast.makeText(
					main,
					"New achivement: " + maxLocalValue
							+ "\nYou can be proud now.", Toast.LENGTH_LONG)
					.show();
			break;
		case 32768:
			Toast.makeText(
					main,
					"New achivement: " + maxLocalValue
							+ "\nWow, that is something!", Toast.LENGTH_LONG)
					.show();
			break;
		case 65536:
			Toast.makeText(
					main,
					"New achivement: " + maxLocalValue
							+ "\nI cannot believe it...", Toast.LENGTH_LONG)
					.show();
			break;
		case 131072:
			Toast.makeText(
					main,
					"New achivement: " + maxLocalValue
							+ "\nYou are so nerdy :)", Toast.LENGTH_LONG)
					.show();
			break;
		}
	}
